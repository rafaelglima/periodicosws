...
driver.get('https://www.periodicos.unimontes.br/index.php/')
...
for j in range(len(i)):
    ...
    versoes = driver.find_elements(By.XPATH,"//a[@class='cover']")
    v = []
    for r in versoes:
        ...
        for y in range(len(k)):
            ...
            try:
                if driver.find_element(By.XPATH,"//ul[@class='authors']").text:
                    autores = driver.find_element(By.XPATH,"//ul[@class='authors']").text
                    time.sleep(0)
            except:
                autores = ''
